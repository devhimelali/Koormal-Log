...
@section('content')
    ...
    <div class="modal fade" id="addOrEditLabourModal" tabindex="-1" aria-labelledby="addOrEditLabourModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('labours.store') }}" id="labourAddForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <label for="crew_id" class="form-label">Crew Name <span class="text-danger">*</span></label>
