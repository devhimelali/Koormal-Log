...
@section('content')
    ...
    <div class="modal fade" id="addOrEditHandoverCompletionModal" tabindex="-1"
        aria-labelledby="addOrEditHandoverCompletionModalLabel" aria-hidden="true">
                ...
                <form action="{{ route('handover-completion-questions.store') }}" id="handoverCompletionAddForm"
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            ...
                            <textarea class="form-control" id="question" name="question" placeholder="Enter Question" cols="30"
                                rows="5"></textarea>
        ...
        $(document).ready(function() {
            ...
            $('#handoverCompletionAddForm').submit(function(e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function() {
                        ajaxBeforeSend('#handoverCompletionAddForm',
                            '#addOrEditAssetSubmitBtn');
                    },
            ...
            $('#addOrEditHandoverCompletionModal').on('hidden.bs.modal', function() {
                ...
                $('#handoverCompletionAddForm').attr('action',
                    "{{ route('handover-completion-questions.store') }}");
            ...
            $('body').on('click', '.delete', function() {
                let id = $(this).data('id');
                let deleteUrl = "{{ route('handover-completion-questions.destroy', ':id') }}".replace(':id',
                    id);
